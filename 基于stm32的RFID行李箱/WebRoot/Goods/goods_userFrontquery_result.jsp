...
<%
    ...
    String goodsDescribe = (String)request.getAttribute("goodsDescribe"); //物品描述查询关键字
    String goodIntoTIme = (String)request.getAttribute("goodIntoTIme"); //物品存入时间查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#goodsListPanel" aria-controls="goodsListPanel" role="tab" data-toggle="tab">物品列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Goods/goods_frontAdd.jsp" style="display:none;">添加物品</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>物品id</td><td>物品类型</td><td>物品名称</td><td>物品rfid</td><td>物品价格</td><td>物品描述</td><td>物品存入时间</td><td>仓库数量</td><td>所属用户</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<goodsList.size();i++) {
					    	            		...
					    	            		Goods goods = goodsList.get(i); //获取到物品对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											...
 											<td><%=goods.getGoodsNumb() %></td>
 											<td><%=goods.getGoodsUserObj().getName() %></td>
 											<td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="goodsQueryForm" id="goodsQueryForm" action="<%=basePath %>Goods/userFrontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="goodTypeObj_goodTypeId">物品类型：</label>
			...
			<div class="form-group">
				<label for="goodsDescribe">物品描述:</label>
				<input type="text" id="goodsDescribe" name="goodsDescribe" value="<%=goodsDescribe %>" class="form-control" placeholder="请输入物品描述">
			</div>
			...
			<div class="form-group">
				<label for="goodIntoTIme">物品存入时间:</label>
				<input type="text" id="goodIntoTIme" name="goodIntoTIme" class="form-control"  placeholder="请选择物品存入时间" value="<%=goodIntoTIme %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
            <div class="form-group" style="display:none;">
            	<label for="goodsUserObj_user_name">所属用户：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;物品信息编辑</h4>
      </div>
