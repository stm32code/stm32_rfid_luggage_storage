		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Goods/frontlist">物品列表</a></li>
			    	<li role="presentation" class="active"><a href="#goodsAdd" aria-controls="goodsAdd" role="tab" data-toggle="tab">添加物品</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="goodsAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="goods_goodTypeObj_goodTypeId" class="col-md-2 text-right">物品类型:</label>
						  	 <div class="col-md-8">
						  ...
						  <div class="form-group">
						  	 <label for="goods_goodsName" class="col-md-2 text-right">物品名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="goods_goodsName" name="goods.goodsName" class="form-control" placeholder="请输入物品名称">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="goods_goodsRfid" class="col-md-2 text-right">物品rfid:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="goods_goodsRfid" name="goods.goodsRfid" class="form-control" placeholder="请输入物品rfid" readOnly style="width:60%;float:left" >
								<span onclick="getRfid();" class="btn btn-primary bottom5 top5" style="float:left;margin-left:10px;">刷卡</span>
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="goods_goodPrice" class="col-md-2 text-right">物品价格:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="goods_goodPrice" name="goods.goodPrice" class="form-control" placeholder="请输入物品价格">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="goods_goodsDescribe" class="col-md-2 text-right">物品描述:</label>
						  	 <div class="col-md-8">
							    <textarea id="goods_goodsDescribe" name="goods.goodsDescribe" rows="8" class="form-control" placeholder="请输入物品描述"></textarea>
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="goods_goodIntoTImeDiv" class="col-md-2 text-right">物品存入时间:</label>
						  	 <div class="col-md-8">
				                <div id="goods_goodIntoTImeDiv" class="input-group date goods_goodIntoTIme col-md-12" data-link-field="goods_goodIntoTIme">
				                    <input class="form-control" id="goods_goodIntoTIme" name="goods.goodIntoTIme" size="16" type="text" value="" placeholder="请选择物品存入时间" readonly>
						  ...
						  <div class="form-group"  style="display:none;">
						  	 <label for="goods_goodsUserObj_user_name" class="col-md-2 text-right">所属用户:</label>
						  	 <div class="col-md-8">
