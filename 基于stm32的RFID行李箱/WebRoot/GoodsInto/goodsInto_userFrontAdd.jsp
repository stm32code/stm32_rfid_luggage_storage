				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="goodsIntoAdd"> 
						  ...
						  <div class="form-group">
						  	 ...
						  	 <div class="col-md-8">
							    <input type="text" id="goodsInto_goodsRfid" name="goodsInto.goodsRfid" class="form-control" placeholder="请输入物品rfid" readOnly  style="width:60%;float:left">
...
var basePath = "<%=basePath%>";
	...
	function ajaxGoodsIntoAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "GoodsInto/userAdd",
			dataType : "json" , 
	...
	function getRfid() {
		$.ajax({
			...
			success: function(obj,response,status) { 
				if(obj.success){
					alert("刷卡成功！");
					$("#goodsInto_goodsRfid").val(obj.rfid);
