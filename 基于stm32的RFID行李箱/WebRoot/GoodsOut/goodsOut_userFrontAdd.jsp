				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="goodsOutAdd"> 
						  ...
						  <div class="form-group">
						  	 ...
						  	 <div class="col-md-8">
							    <input type="text" id="goodsOut_goodsRfid" name="goodsOut.goodsRfid" class="form-control" placeholder="请输入物品rfid" readOnly  style="width:60%;float:left">
							    <span onclick="getRfid();" class="btn btn-primary bottom5 top5" style="float:left;margin-left:10px;">刷卡</span>
							 </div>
						  </div>
						  
						  <div class="form-group">
						  	 <label for="goodsOut_outGoodsRfid_goodsId" class="col-md-2 text-right">物品名称:</label>
						  	 <div class="col-md-8">
...
var basePath = "<%=basePath%>";
	...
	function getRfid() {
		$.ajax({
			type : "get",
			url : basePath + "GoodsOut/getRfid",
			dataType : "json" , 
			data: {},
			success: function(obj,response,status) { 
				if(obj.success){
					alert("刷卡成功！");
					$("#goodsOut_goodsRfid").val(obj.rfid);
