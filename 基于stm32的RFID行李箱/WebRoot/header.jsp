...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">行李箱寄存</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>GoodsType/frontlist">物品类型</a></li>
                <li><a href="<%=basePath %>Goods/frontlist">物品查询 </a></li>
                <li><a href="<%=basePath %>GoodsInto/frontlist">入箱查询</a></li>
                <li><a href="<%=basePath %>GoodsOut/frontlist">出箱查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Goods/goods_frontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;新物品登记</a></li>
                        <li><a href="<%=basePath %>Goods/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的物品管理</a></li>
                        <li><a href="<%=basePath %>GoodsInto/goodsInto_userFrontAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;物品入箱</a></li>
                        <li><a href="<%=basePath %>GoodsOut/goodsOut_userFrontAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;物品出箱</a></li>
